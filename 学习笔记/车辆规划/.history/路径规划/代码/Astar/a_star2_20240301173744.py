...
def main():
    ...
    obstacle_ratio = 0.5  # Ratio of obstacles in the map
    ...
    gx = map_width - grid_size  # Goal position x
    gy = map_height - grid_size   # Goal position y
    ...
    if rx and ry:  # Check if the path is not empty
        if show_animation:
            plt.plot(rx, ry, "-r")  # Plot planned path
            plt.pause(0.1)
            plt.show()
    else:
