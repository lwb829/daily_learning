...
![image-20231113220254104](C:\Users\李文博\AppData\Roaming\Typora\typora-user-images\image-20231113220254104.png)
...
- 类的静态成员：指声明为**static的成员**，在类的范围内**所有对象共享该数据**
  - 引用格式：
    - <类名>：：<静态成员>
    - 对象名.共有静态成员
    - 对象指针->静态成员
  ...
  - 静态成员函数：
    ...
    - 不访问类中的非静态成员
- const：保护即需要共享、又需要防止改变的数据，应该声明为常量进行保护
  - 常数据成员————const修饰数据成员
  - 常成员函数————const修饰成员函数
