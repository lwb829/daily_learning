...
class MyReferencePath:
    def __init__(self):
        ...
        self.refer_path[:, 1] = np.full_like(self.refer_path[:, 0], 0.0)
        # 2*np.sin(self.refer_path[:, 0]/3.0) + \
...
def main():
    ...
    animation.save('E:/无人车项目/github仓库/lwb/学习笔记/代码/lqr.gif', fps=50, writer='pillow')
