...
```
<arg name="front_vehicle_x_size" default="4"/>   <!-- 车base_link到前面的长度 -->
<arg name="back_vehicle_x_size" default="2"/>    <!-- 车base_link到后面的长度 -->
<arg name="half_vehicle_y_size" default="1.5"/>    <!-- 车base_link到侧面的长度 -->
```
